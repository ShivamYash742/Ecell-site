        ...
        <footer className="bg-black text-white p-8">
            <div className="container mx-auto px-4 ">
                <div className="flex flex-wrap justify-around items-center pb-12 gap-5">
                    {/* Company Logo */}
                    <div className="">
                        <img src={logo} alt="Company Logo" className="" width={80} height={80} />
                    </div>
                    ...
                    <div className="">
                        ...
                        <div className="flex space-x-4 items-center justify-start">
                            <a href="https://www.instagram.com/ecellmsit/" className="hover:text-gray-400" target='blank'>
                                <img src={instagramLogo} alt="" width={25} height={25} />
                            </a>
                            <a href="https://in.linkedin.com/company/ecellmsit" className="hover:text-gray-400" target='blank'>
                                <img src={linkedinLogo} alt="" width={15} height={15}/>
                            </a>
                            <a href="https://www.facebook.com/ecellmsit/" className="hover:text-gray-400" target='blank'>
